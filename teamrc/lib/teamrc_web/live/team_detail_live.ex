      ...
      <div class="max-w-md mx-auto mt-16 text-center space-y-4">
        <div class="flex justify-center">
          <div class="flex h-12 w-12 items-center justify-center rounded-full bg-base-200">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-base-content/30" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
        ...
        <p class="text-xs text-base-content/40">
          Ask the team owner for an invite, or
          <a href={~p"/new"} class="text-primary hover:text-primary/80">create your own team</a>.
        </p>
      </div>
    <% else %>
      <div class="max-w-2xl mx-auto space-y-8">
        ...
        <div>
          <div :if={@editing_section != "name"} class="flex items-center gap-3">
            ...
            <span class={[
              ...
              <svg :if={@team.visibility == "private"} xmlns="http://www.w3.org/2000/svg" class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
              </svg>
              <svg :if={@team.visibility == "public"} xmlns="http://www.w3.org/2000/svg" class="h-2.5 w-2.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
        ...
        <section :if={@access_level == :viewer && @team.clone_token}>
          <div class="rounded-lg border border-primary/20 bg-primary/5 p-4 space-y-2">
            ...
            <div class="terminal-block rounded-lg overflow-hidden">
              <div class="px-3 py-2">
                <code class="text-emerald-400 text-xs font-mono">npx teamrc clone {@team.clone_token}</code>
              </div>
            </div>
            <p class="text-xs text-base-content/40">
        ...
        <section :if={@can_edit}>
          ...
          <div :if={@team.visibility == "public" && @clone_token} class="mt-4 pt-4 border-t border-base-300">
            <p class="text-xs font-medium text-base-content/50 uppercase tracking-wider mb-2">Clone Token</p>
            <p class="text-xs text-base-content/40 mb-2">Anyone with this token can copy the team config (read-only, no sync).</p>
            <div class="terminal-block rounded-lg overflow-hidden">
              <div class="px-3 py-2">
                <code class="text-emerald-400 text-xs font-mono">npx teamrc clone {@clone_token}</code>
              </div>
            </div>
          </div>
        </section>
