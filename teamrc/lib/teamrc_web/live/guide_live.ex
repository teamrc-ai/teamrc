  ...
  defp page_cli(assigns) do
    ...
    <section class="space-y-4">
      ...
      <.cli_command
        ...
        details="Like join, but doesn't register this machine with the relay. You get a local copy of the team definition. Cloned teams support read-only pull (to fetch updates from the original) but not push or sync. To fork a cloned team into your own, run teamrc init, which will adopt the existing definition, create a new team on the relay, and give you full ownership."
      />
    </section>
