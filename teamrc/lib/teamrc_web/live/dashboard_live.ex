              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                  ...
                  <a
                    ...
                    class="trc-focus shrink-0 inline-flex items-center gap-1 rounded px-1.5 py-0.5 text-[11px] font-medium text-primary/70 hover:text-primary hover:bg-primary/5 transition-colors"
                  >
                    View
