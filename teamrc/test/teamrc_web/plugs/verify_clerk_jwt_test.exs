defmodule TeamrcWeb.Plugs.VerifyClerkJWTTest do
  use TeamrcWeb.ConnCase, async: false

  alias TeamrcWeb.Plugs.VerifyClerkJWT
  ...
  setup do
    ...
    original = Application.get_env(:teamrc, :skip_clerk_auth, false)
    ...
    on_exit(fn ->
      Application.put_env(:teamrc, :skip_clerk_auth, original)
