defmodule TeambridgeWeb.Plugs.VerifyClerkJWT do
  @moduledoc """
  ...
  ## Configuration
      ...
      config :teambridge, Teambridge.ClerkJWT,
  ...
  def call(conn, _opts) do
    if @skip_auth_allowed and Application.get_env(:teambridge, :skip_clerk_auth, false) do
      conn
    else
  ...
  defp validate_claims(claims) do
    config = Application.get_env(:teambridge, Teambridge.ClerkJWT, [])
